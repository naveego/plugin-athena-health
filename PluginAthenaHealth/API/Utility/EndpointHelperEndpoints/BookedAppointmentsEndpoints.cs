...
{
    public class BookedAppointmentsEndpointHelper
    {
        private class BookedAppointmentsEndpoint : Endpoint
        {
            ...
            public override async IAsyncEnumerable<Record> ReadRecordsAsync(IApiClient apiClient, Schema schema, bool isDiscoverRead = false)
            {
                ...
                foreach (var department in departmentResponse.Departments)
                {
                    ...
                    var bookedApptsPath =
                        $"{settings.GetBaseUrl().TrimEnd('/')}/{settings.PracticeId}/appointments/booked?startdate={settings.StartDate}&enddate={settings.EndDate}&departmentid={thisDepartmentId}";
        ...
        {
            {
                "AllBookedAppointments", new BookedAppointmentsEndpoint
                {
                    Id = "AllBookedAppointments",
