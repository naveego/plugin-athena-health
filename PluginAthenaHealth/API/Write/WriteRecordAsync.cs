    ...
    public static partial class Write
    {
            ...
            IServerStreamWriter<RecordAck> responseStream)
        {
            ...
            try
            {
                ...
                //if writemode = local or googlecloudstorage ? Retrieve from schema
                //retrieve path from second source, download file locally, POST to patientchart endpoint
                //delete local file generated by googlecloudstorage after POSTing to pateintchart endpoint
